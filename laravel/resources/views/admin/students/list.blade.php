                ...
                <div class="table-agile-info">
                    <div class="panel panel-default">
                        ...
                        <div class="row w3-res-tb">
                            <div class="col-sm-3">
                                <a type="button" class="btn btn-primary" onclick="student.openModal(this)">Thêm mới</a>
                            </div>
                        </div>
                        <div class="table-responsive" id="loadtable">
                            <table class="table table-striped table-hover" id="tbStudent">
                        ...
                        <div class="modal fade" id="addEditStudent" tabindex="-1" role="dialog"
                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="studentTitle">Thêm mới giáo viên</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body" id="modalBody">
                                        <form enctype="multipart/form-data" id="frAddEditStudent">
                                            @csrf
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-5">
                                                    <div class="row form-group divUpload">
                                                        <label for="file-upload" class="custom-file-upload">
                                                            <img src="/storage/images/unnamed.jpg" alt="ảnh"
                                                                id="avatar" style="width:200px; height:200px">
                                                        </label>
                                                        <input type="text" name="image64" hidden id="image64">
                                                        <input id="file-upload" type="file"
                                                            onchange="student.uploadAvatar(this)" name="inputFile"
                                                            accept="image/*" />
                                                    </div>
                                                    ...
                                                    <div class="form-row form-group">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="date" class="form-control" id="date_start"
                                                                name="date_start">
                                                            <div id="errorDate_start" style="color: red; font-size: 12px">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="date" class="form-control" id="date_end"
                                                                name="date_end">
                                                            <div id="errorDate_end" style="color: red; font-size: 12px"></div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group mb-3">
                                                        <div class="form-group-prepend">
                                                            <label class="form-group-text mt-2" for="classe">Lớp học</label>
                                                        </div>
                                                        <select class="custom-select form-control" id="classe" name="classe">
